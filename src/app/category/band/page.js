...
export default function BandsPage() {
  ...
  const bands = [
    { name: 'Rock Band', image: '/band.jpg', link: '/category/rock-band' },
    { name: 'Jazz Band', image: '/band.jpg', link: '/category/jazz-band' },
    { name: 'Pop Band', image: '/band.jpg', link: '/category/pop-band' },
    { name: 'Folk Band', image: '/band.jpg', link: '/category/folk-band' },
    { name: 'Blues Band', image: '/band.jpg', link: '/category/blues-band' },
  ];
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 py-12 mt-16">
        <h2 className="text-3xl font-bold text-white mb-8">Bands</h2>
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
          {bands.map((band, index) => (
            <Link key={index} href={band.link} passHref>
