...
export default function BalletDancerPage() {
  ...
  const dancers = [
    {
      name: 'Dwight Howard',
      description: 'An exceptional ballet dancer with a passion for classical performances.',
      image: '/dwight.jpg', // Replace with actual image paths
      rating: 4,
      link: 'ballet-dancer/dwighthoward'
    },
    {
      name: 'Shaq Oneal',
      description: 'A talented ballet dancer known for his contemporary style.',
      image: '/shaq.jpg', // Replace with actual image paths
      rating: 5,
      link: 'ballet-dancer/shaqoneal'
    },
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 py-12 mt-16">
        <h2 className="text-3xl font-bold text-white mb-8">Ballet Dancers</h2>
