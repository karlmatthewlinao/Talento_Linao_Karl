...
export default function ContemporaryDancerPage() {
  ...
  const dancers = [
    {
      name: 'Bato Dela Rosa',
      description: 'A dynamic Tap dancer known for her innovative choreography.',
      image: '/contemporary-dancer1.jpg', // Replace with actual image paths
      rating: 5,
      link: '/dancer/tap-dancer/bato'
    },
    {
      name: 'Bong Go',
      description: 'A passionate Tap dancer specializing in improvisation.',
      image: '/contemporary-dancer2.jpg', // Replace with actual image paths
      rating: 4,
      link: '/dancer/tap-dancer/bong'
    },
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 py-12 mt-16">
        <h2 className="text-3xl font-bold text-white mb-8">Tap Dancers</h2>
