...
export default function ContemporaryDancerPage() {
  ...
  const dancers = [
    {
      name: 'Lebron James',
      description: 'A dynamic contemporary dancer known for her innovative choreography.',
      image: '/contemporary-dancer1.jpg', // Replace with actual image paths
      rating: 5,
      link: '/dancer/contemporary-dancer/lebronjames'
    },
    {
      name: 'Noah Brown',
      description: 'A passionate contemporary dancer specializing in improvisation.',
      image: '/contemporary-dancer2.jpg', // Replace with actual image paths
      rating: 4,
      link: '/dancer/noah-brown'
    },
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 py-12 mt-16">
        <h2 className="text-3xl font-bold text-white mb-8">Contemporary Dancers</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {dancers.map((dancer, index) => (
            <Link key={index} href={dancer.link} passHref>
              <div className="bg-white p-4 rounded-lg shadow-md text-center cursor-pointer transform hover:scale-105 transition-transform">
                ...
                />
                <h3 className="text-lg font-semibold text-black">{dancer.name}</h3>
                <p className="text-gray-700">{dancer.description}</p>
