...
export default function ContemporaryDancerPage() {
  ...
  const dancers = [
    {
      name: 'Draymond Green',
      description: 'A dynamic hiphop dancer known for her innovative choreography.',
      image: '/contemporary-dancer1.jpg', // Replace with actual image paths
      rating: 5,
      link: '/dancer/emma-thompson'
    },
    {
      name: 'Mark Wahlberg',
      description: 'A passionate hiphop dancer specializing in improvisation.',
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 py-12 mt-16">
        <h2 className="text-3xl font-bold text-white mb-8">Hiphop Dancers</h2>
