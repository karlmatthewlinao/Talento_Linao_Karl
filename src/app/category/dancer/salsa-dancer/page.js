...
export default function ContemporaryDancerPage() {
  ...
  const dancers = [
    {
      name: 'Usain Bolt',
      description: 'A dynamic Salsa dancer known for her innovative choreography.',
      image: '/contemporary-dancer1.jpg', // Replace with actual image paths
      rating: 5,
      link: '/dancer/salsa-dancer/usain'
    },
    {
      name: 'Dolphy Quezon',
      description: 'A passionate Salsa dancer specializing in improvisation.',
      image: '/contemporary-dancer2.jpg', // Replace with actual image paths
      rating: 4,
      link: '/dancer/salsa-dancer/dolphy'
    },
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 py-12 mt-16">
        <h2 className="text-3xl font-bold text-white mb-8">Salsa Dancers</h2>
