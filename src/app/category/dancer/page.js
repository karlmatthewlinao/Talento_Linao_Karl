...
export default function DancersPage() {
  ...
  const dancers = [
    { name: 'Ballet Dancer', image: '/dancer.jpg', link: '/category/dancer/ballet-dancer' },
    { name: 'Contemporary Dancer', image: '/dancer.jpg', link: '/category/dancer/contemporary-dancer' },
    { name: 'Hip Hop Dancer', image: '/dancer.jpg', link: '/category/dancer/hiphop-dancer' },
    { name: 'Salsa Dancer', image: '/dancer.jpg', link: '/category/dancer/salsa-dancer' },
    { name: 'Tap Dancer', image: '/dancer.jpg', link: '/category/dancer/tap-dancer' },
  ];
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 py-12 mt-16">
        <h2 className="text-3xl font-bold text-white mb-8">Dancers</h2>
